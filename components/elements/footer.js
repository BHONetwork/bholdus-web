  ...
  return (
    ...
    >
      <div className="container flex flex-col flex-1 justify-between">
        <div>{children}</div>
        <div className="flex flex-col gap-14 lg:gap-0 lg:flex-row items-center justify-between my-20">
          <CustomLink link={{ url: "/" }}>
            <Image img={footer.logo} style={{ width: 186, height: 58 }} />
          </CustomLink>
          <div className="flex flex-row items-center gap-1 ml-0 lg:ml-24">
            <Image
              img={{ url: "../../social_3.svg" }}
              style={{ width: 28, height: 28 }}
            />
            <Image
              img={{ url: "../../social_2.svg" }}
              style={{ width: 28, height: 28 }}
            />
            <Image
              img={{ url: "../../social_1.svg" }}
              style={{ width: 28, height: 28 }}
            />
          </div>
